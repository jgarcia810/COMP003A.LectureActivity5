...
namespace COMP003A.LectureActivity5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            HelloWorld("Ada Lovelance", DateTime.Now.Year - 1815); //call to
        ...
        */
        ...
        { 
            Console.WriteLine($"HelloWorld: {inputName}");
        }
        ...
        /// <summary>
        /// Method for getting the remainder after diving two numeric variables 
        /// </summary>
        /// <param name="num1">Decimal input</param>
        /// <param name="num2">Decimal input</param>
        /// <returns>Remainder after diving two decimal inputs</returns>
